...
def download_single_file(
    ...
    request_parameters.update(
        {"pressure_level": pressure_level} if level_type == "pressure" else {}
    )
...
def download_years_separately(
    ...
    for year in years:
        download_single_file(
            ...
            else custom_fn.rstrip(".nc") + year + ".nc",
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--level_type", type=str, help="'single' or 'pressure'", required=True
    )
    parser.add_argument(
        "--pressure_level",
        type=str,
    ...
    parser.add_argument(
        "--output_dir", type=str, help="Directory where file is stored", required=True
    )
    parser.add_argument(
        "--years",
        type=str,
    ...
    parser.add_argument(
        "--day", type=str, nargs="+", help="Day(s) to download data", default=all_days
    )
    parser.add_argument(
        "--time",
        type=str,
